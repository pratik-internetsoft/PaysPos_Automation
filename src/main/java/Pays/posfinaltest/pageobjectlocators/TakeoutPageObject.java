...
public class TakeoutPageObject  {
	 private AppiumDriver driver;
	    private WebDriverWait wait;
	 
		public TakeoutPageObject(AppiumDriver driver) {
			this.driver = driver;
			PageFactory.initElements(new AppiumFieldDecorator(driver), this); // Initialize PageFactory elements

		}
	@AndroidFindBy(xpath="//android.widget.TextView[@resource-id=\"com.pays.pos:id/txtTitle\" and @text=\"Take Out\"]")
